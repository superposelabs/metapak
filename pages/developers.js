    ...
    <div style={{width:"100vw",maxWidth:"100vw",overflowY:"hidden"}}>
        ...
        <GridContainer>
            <GridItem xs={12} sm={12} md={8}>
                <h1 className={classes.heroTitle}>Developer Resources</h1>
                <h3 className={classes.heroSubTitle}>
                    Developer Support for dApps, marketplaces, digital wallets, and general Web3.
                </h3>
