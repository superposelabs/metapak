...
const buttonStyle = {
  ...
  outlined: {
    ...
    "&$linkedin": {
      "&,&:focus,&:hover,&:visited": {
        color: linkedinColor,
        border: "1px solid " + linkedinColor,
      },
    },
    "&$pinterest": {
      "&,&:focus,&:hover,&:visited": {
        color: pinterestColor,
        border: "1px solid " + pinterestColor,
      },
    },
    "&$youtube": {
      "&,&:focus,&:hover,&:visited": {
        color: youtubeColor,
        border: "1px solid " + youtubeColor,
      },
    },
    "&$tumblr": {
      "&,&:focus,&:hover,&:visited": {
        color: tumblrColor,
        border: "1px solid " + tumblrColor,
      },
    },
    "&$github": {
      "&,&:focus,&:hover,&:visited": {
    ...
    "&$behance": {
      "&,&:focus,&:hover,&:visited": {
        color: behanceColor,
        border: "1px solid " + behanceColor,
      },
    },
    "&$dribbble": {
      "&,&:focus,&:hover,&:visited": {
        color: dribbbleColor,
        border: "1px solid " + dribbbleColor,
      },
    },
    "&$reddit": {
      "&,&:focus,&:hover,&:visited": {
        color: redditColor,
        border: "1px solid " + redditColor,
      },
    },
  },
  simple: {
