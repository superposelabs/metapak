...
import portal from "assets/img/bg-pricing.jpeg";
...
export default function Pages(props) {
  ...
  const getBgImage = () => {
    if (router.route.indexOf("/auth/register-page") !== -1) {
      ...
      return pricing;
    } else if (router.route.indexOf("/auth/portal") !== -1) {
      return portal;
    } else if (router.route.indexOf("/portals") !== -1) {
      return portal;
  ...
  const getActiveRoute = (routes) => {
    let activeRoute = "Transporting through the portal";
